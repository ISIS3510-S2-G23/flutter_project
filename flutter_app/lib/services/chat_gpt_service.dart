  ...
  Future<String?> validatePhoto(String imagePath) async {
    try {
      ...
      final response = await http.post(
        ...
        body: json.encode({
          'model': 'gpt-4o', // Cambiado a gpt-4o que tiene capacidades de visión
          'messages': [
            {
              'role': 'user',
              'content': [
      ...
      if (response.statusCode == 200) {
        ...
        final content = data['choices'][0]['message']['content']?.toString().trim().toUpperCase();
